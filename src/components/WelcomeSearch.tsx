    ...
    <div className="w-full max-w-3xl px-4">
      <div className="mb-4">
        ...
        <p className="mt-2 text-sm text-white/80">
          Type a ticker (e.g., AAPL) to see live charts & stats.
        </p>
      </div>
      <form className="relative" onSubmit={handleSubmit}>
        <div className="absolute left-2 top-1/2 -translate-y-1/2">
          <button
            className="absolute top-1/2 -translate-y-1/2 p-1 rounded-full hover:bg-gray-200"
            type="submit"
          >
            <svg
        ...
        <input
          className="w-full py-3 pl-12 pr-4 border border-gray-300 rounded-full shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          type="text"
          value={inputValue}
